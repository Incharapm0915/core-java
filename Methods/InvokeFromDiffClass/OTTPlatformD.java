class OTTPlatformD {
    ...
    public static void getPlatformTitles(){
        ...
        System.out.println("\nChinese Titles:");
        for(String chinesetitle : chinese) {
            System.out.println(chinesetitle);
        }       
        
        System.out.println("\nThai Titles:");
        for(String thtitle : thai) {
            System.out.println(thtitle);
        }   

        System.out.println("\nIndonesian Titles:");
        for(String indotitle : indonesian) {
             System.out.println(indotitle);
        }
       

        System.out.println("\nArabic Titles:");
        for(String arabictitle : arabic){
            System.out.println(arabictitle);
        }
        
        System.out.println("\nBengali Titles:");
        for(String bengalititle : bengali){
            System.out.println(bengalititle);
        }
        
        System.out.println("\nGujarati Titles:");
        for(String gujaratititle : gujarati){
            System.out.println(gujaratititle);
        } 
